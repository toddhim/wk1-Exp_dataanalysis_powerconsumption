...
with(Feb1_2, {  
  ...
  plot(Feb1_2$Global_active_power,type="l",lwd=1,
      xaxt="n",ylim=c(0,6),col="black",
      xlab = "", ylab="Global Active Power")
  days = c("Thu","Fri","Sat")
  axis(1,at=c(0,1441,2880), labels=days)  

  plot(Feb1_2$Sub_metering_1,type="l",lwd=1, 
  ...
  plot(Feb1_2$Voltage,type="l",lwd=1, 
       xaxt="n",ylim=c(234,246),col="black", 
       xlab = "datetime", ylab="Voltage (volt)")
  days = c("Thu","Fri","Sat")
  axis(1,at=c(0,1441,2880), labels=days) 

  plot(Feb1_2$Global_reactive_power,type="l",lwd=1,
